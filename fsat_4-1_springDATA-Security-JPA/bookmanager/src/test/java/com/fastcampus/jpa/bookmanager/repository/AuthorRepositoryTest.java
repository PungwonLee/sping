...
class AuthorRepositoryTest {
    ...
    void manyToManyTest(){
        ...
        System.out.println("bookRepository = " + bookRepository.findAll().get(2).getAuthors());
        System.out.println("authorRepository.findAll().get(0).getBooks() = " + authorRepository.findAll().get(0).getBooks());
    }
