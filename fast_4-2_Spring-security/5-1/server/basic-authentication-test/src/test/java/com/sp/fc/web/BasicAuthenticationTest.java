...
public class BasicAuthenticationTest {
    ...
    void test_2(){
        ...
        assertEquals(resp.getBody(),"hello");
    ...
    void test_4() {
        TestRestTemplate testClient = new TestRestTemplate("user1", "1111");
        ResponseEntity<String> resp = testClient.postForEntity(greetingUrl(), "pungwon", String.class);
        assertEquals("hello pungwon",resp.getBody());
    }
}
